...
import { storageLocalPut, storageLocalGet } from './storage-local';
...
function getStorageConfig(): StorageConfig {
  ...
  if (!baseUrl || !apiKey || baseUrl.includes('demo') || apiKey === 'demo-key') {
    console.log('[Storage] Using local file storage for development');
    return null as any; // Signal to use local storage
  }
