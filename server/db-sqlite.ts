...
function seedDatabase(sqlite: InstanceType<typeof Database>) {
  ...
  sqlite.exec(`
    ...
    (3, 'Industrial Construction', 'industrial-construction', 'Warehouses and manufacturing facilities', 'Specialized in industrial construction including warehouses, manufacturing plants, and distribution centers.', 'Factory', 'https://images.unsplash.com/photo-1565636291267-c23a0f4d6a1b?w=800&h=500&fit=crop', 'industrial', '["Heavy Duty Construction","Safety Standards","Automated Systems","Scalable Design"]', 1, 3, 1767705908, 1767705908),
